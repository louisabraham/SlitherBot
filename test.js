...
var wumsts = !1, rank = 0, best_rank = 999999999, snake_count = 0, biggest_snake_count = 0, cm1, snakes = [], foods = [], foods_c = 0, preys = [], os = {}, lsang = 0, want_e = !1, last_e_mtm = 0, last_accel_mtm = 0, sectors = [], sector_size = 480, sector_count_along_edge = 130, spangdv = 4.8, nsp1 = 4.25, nsp2 = .5, nsp3 = 12, mamu = .033, mamu2 = .028, cst = .43, lfas = [], lfc = 128;
no_raf = !0
var testing = !1;
...
var oef = function() {
    ...
    ws.send(q))),
    !wfpr && 250 < c - last_ping_mtm && (last_ping_mtm = c,
    wfpr = !0,
    q = new Uint8Array(1),
